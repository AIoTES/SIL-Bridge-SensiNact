...
/**
 * This classes loads Sensinact Ontology and create individuals on that ontology according to information sent to updateOntology
 */
public class SNAOntologyAggregator {
    ...
    public OntModel transformOntology(String provider,String service,String resource,String value){
        ...
        InputStream is=this.getClass().getResourceAsStream(filepath);
        isolatedModel.read(is,null,"RDF/XML");
    ...
    /**
     * Create individuals necessary to receive the information passed to this method and link them in the ontology instance
     * @param provider device name in sensinact
     * @param service group of particular information in sensinact
     * @param resource the leaf node that contains the metadata of the information
